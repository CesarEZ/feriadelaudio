      ...
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              &nbsp; Añadir nueva factura </h3>
          </div>
          <div class="d-inline-block float-right">
             <a href="<?= base_url('admin/invoices'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Lista de facturas</a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card">
                  <div class="card-header with-border">
                    <h3 class="card-title">Factura desde</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="company_name" class="control-label">nombre de empresa</label>
                        <input type="text" name="company_name" class="form-control" id="company_name" value="Codeglamour" placeholder="" required>
                      </div>
                      
                      <div class="form-group">
                        <label for="address1" class="control-label">Dirección Línea 1</label>
                      ...
                      <div class="form-group">
                        <label for="address2" class="control-label">Dirección Línea 2</label>
                      ...
                      <div class="form-group">
                        <label for="mobile_no" class="control-label">No. Móvil</label>
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-header with-border">
                    <h3 class="card-title">Factura hasta</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <div class="card-body">
                      <div class="form-group">
                        <label for="firstname" class="control-label">Cliente</label>
                        <select class="form-control" name="user_id" id="customer" required="">
                          <option value="">Por favor seleccione cliente</option>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="invoice_no" class="control-label">Factura#</label>
                          <input type="text" name="invoice_no" class="form-control" id="invoice_no" placeholder="eg. Inv-1001" required>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <label for="date" class="control-label">Fecha de facturación</label>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="firstname" class="control-label" required>Estado</label>
                          <select class="form-control" name="payment_status">
                            <option value="Unpaid">No pagado</option>
                            <option value="Partially Paid">Parcialmente pagado</option>
                      ...
                      <table class="table">
                        ...
                        <tr>
                          ...
                          <td class="text-right"><div class="form-group">
                              <input type="text" name="discount" class="form-control calcEvent pull-right input-sm width-4pc" id="discount" placeholder="" required>
                            </div></td>
                        </tr>
                        <tr>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                     <div class="form-group">
                        <label for="invoice_no" class="control-label">Nota del cliente</label>
                        <textarea name="client_note" class="form-control" rows="2" placeholder="" ></textarea>
                      </div>
                      <div class="form-group">
                        <label for="invoice_no" class="control-label">Términos y Condiciones</label>
