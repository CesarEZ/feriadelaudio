      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            ...
            <a href="<?= base_url('admin/invoices/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Añadir nueva factura</a>
          </div>
        </div>
        <div class="card-body">
                        ...
                        <table class="table">
                          ...
                          <tr>
                            ...
                            <td class="text-right"><div class="form-group">
                                <input type="text" name="discount" value="<?= $invoice_detail['discount']; ?>" class="form-control calcEvent pull-right input-sm width-40pc" id="discount" placeholder="">
                              </div></td>
                          </tr>
                          <tr>
