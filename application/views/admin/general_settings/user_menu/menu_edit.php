      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/general_settings/user_menu'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Lista de menú</a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/general_settings/menu_edit/'.$module['id']), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="module_name" class="col-md-2 control-label">Nombre del menú</label>
              ...
              <div class="form-group">
                <label for="operation" class="col-md-2 control-label">Estado</label>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Actualizar menú" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
        </div>
