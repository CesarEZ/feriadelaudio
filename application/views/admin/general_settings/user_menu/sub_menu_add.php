      ...
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              Agregar nuevo submenú </h3>
          </div>
          <?php $parent_menu = $this->uri->segment(4); ?>
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/general_settings/sub_menu/'.$parent_menu); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Lista de submenús</a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/general_settings/sub_menu_add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="module_name" class="col-md-2 control-label">Nombre</label>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <input type="submit" name="submit" value="Agregar submenú" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
        </div>
