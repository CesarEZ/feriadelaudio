    ...
    <div class="card card-default">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"> <i class="fa fa-list"></i>&nbsp; Países </h3>
        </div>
        <div class="d-inline-block pull-right">
          <a href="<?= base_url('admin/misc/country/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Agregar nuevo país</a>
        </div>
      </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable({
    "processing": true,
    "serverSide": false,
    "ajax": "<?= base_url('admin/misc/country_datatable_json') ?>",
    "order": [[1,'asc']],
    "columnDefs": [
