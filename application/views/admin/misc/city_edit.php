  ...
  <div class="card card-default">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"> <i class="fa fa-list"></i>&nbsp; Editar ciudad </h3>
        </div>
      ...
      <div class="card-body">
        <?php echo form_open(base_url('admin/misc/city/edit/'.$city['id']), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" name="city" class="form-control" value="<?= $city['name']; ?>" id="name" placeholder="Nombre de la ciudad" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Actualizar ciudad" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
      </div>
