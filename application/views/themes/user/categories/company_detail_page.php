  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        <h1 class="text-white">
          Detalle de la lista de Empleadores
        </h1> 
        <p class="text-white link-nav"><a href="<?= base_url(); ?>">Inicio </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> Detalle de la lista de empleadores</a></p>
      </div>                      
    </div>
  </div>
</section>
          ...
          <div class="emp_details">
            ...
            <div class="job-listing-footer">
              <ul class="mb-3">
                ...
                <li><i class="lnr lnr-map-marker"></i> <?= get_state_name($company_info['state']); ?>, <?= get_country_name($company_info['country']); ?></li>
    ...
    <div class="row justify-content-center d-flex">
      <div class="col-lg-10 post-list">
        ...
        <div class="profile_job_content col-lg-12 mt-5">
          <div class="headline">
            <h3> Apertura de empleos</h3>
          </div>
          <div class="profile_job_detail">
            <div class="row">
              <div class="col-lg-12">
                <?php if(empty($jobs)): ?>
                  <p class="text-gray"><strong>Lo siento,</strong> no hay vacantes en este momento</p>
                <?php endif; ?>
              </div>
                ...
                <div class="single-post d-flex flex-row">
                  ...
                  <div class="details">
                    ...
                    <div class="job-listing-footer">
                      <ul>
                        ...
                        <li><i class="lnr lnr-apartment"></i> <?= get_category_name($job['category']); ?></li>
                  ...
                  <div class="job-listing-btns">
                    <ul class="btns">
                      ...
                      <li><a href="<?= site_url('jobs/'.$job['id'].'/'.($job['job_slug'])); ?>">Aplicar</a></li>
                    </ul>
                  </div>
                </div>
                <?php endforeach; ?>
